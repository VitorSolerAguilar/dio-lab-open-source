...
2. Clone localmente: `git clone https://github.com/VitorSolerAguilar/dio-lab-open-source.git`;
...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`:
    > Exemplo: 'git checkout -b feat/community/VitorSolerAguilar'
5. Dentro da pasta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crie um arquivo em Markdown (extensão `.md`) e nomeie com o mesmo nome do seu usuário no GitHub;
    > Exemplo: `touch community/VitorSolerAguilar.md` <br>
...
7. Adicione suas alterações a "staging area" com o comando `git add community/VitorSolerAguilar.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add VitorSolerAguilar profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/VitorSolerAguilar`; 
...
2. Clone locally: `git clone https://github.com/VitorSolerAguilar/dio-lab-open-source.git`;
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`:
    > Example: `git checkout -b feat/community/VitorSolerAguilar`
5. Inside the [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community) folder, create a Markdown file (extension `.md`) and name it after your GitHub username;
    > Example: `touch community/VitorSolerAguilar.md` <br>
...
7. Add your changes to the "staging area" with the command `git add community/VitorSolerAguilar.md`;
8. Create a commit and add a message indicating the addition of your profile `git commit -m"feat: add VitorSolerAguilar profile"`;
9. Push the changes to your remote repository `git push origin feat/community/VitorSolerAguilar`;
...
2. Clona localmente: `git clone https://github.com/VitorSolerAguilar/dio-lab-open-source.git`;
...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/VitorSolerAguilar`:
    > Ejemplo: `git checkout -b feat/community/VitorSolerAguilar`
5. Dentro de la carpeta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crea un archivo en Markdown (extensión `.md`) y nómbralo con el mismo nombre de tu usuario en GitHub;
    > Ejemplo: `touch community/VitorSolerAguilar.md` <br>
...
7. Agrega tus cambios al "área de preparación" con el comando `git add community/VitorSolerAguilar.md`;
8. Crea un commit y añade un mensaje indicando la adición de tu perfil `git commit -m"feat: add VitorSolerAguilar profile"`;
9. Envía los cambios a tu repositorio remoto `git push origin feat/community/VitorSolerAguilar`;
...
2. Kloon lokaal: git clone https://github.com/VitorSolerAguilar/dio-lab-open-source.git;
...
4. Maak/Referentieer een nieuwe branch en noem het feat/community/YOUR_USERNAME:
    > Voorbeeld: git checkout -b feat/community/VitorSolerAguilar
5. Binnen de community map, creëer een Markdown-bestand (extensie .md) en noem het naar je GitHub-gebruikersnaam;
    > Voorbeeld: touch community/VitorSolerAguilar.md 
...
7. Voeg je wijzigingen toe aan het "staging area" met het commando git add community/VitorSolerAguilar.md;
8. Creëer een commit en voeg een bericht toe dat de toevoeging van je profiel aangeeft git commit -m"feat: add VitorSolerAguilar profile";
9. Push de wijzigingen naar je externe repository git push origin feat/community/VitorSolerAguilar;
